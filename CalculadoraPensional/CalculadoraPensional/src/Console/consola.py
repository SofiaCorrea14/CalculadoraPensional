from ..CalculadoraPensional.CalculadoraPensional import calcular_pension, edad_negativa, saldo_negativo, rentabilidad_negativa, administracion_negativa, semanas_negativas, semanas_insuficientes, edad_insuficiente, sexo_invalido

def ejecutar_calculo_pension():
    try:
        datos = solicitar_datos_por_consola()
        resultado = calcular_pension(*datos)
        mostrar_resultado(*resultado)
    except (edad_negativa, saldo_negativo, rentabilidad_negativa, administracion_negativa, semanas_negativas, semanas_insuficientes, edad_insuficiente, sexo_invalido) as e:
        print("Error:", e)
...
def solicitar_float_positivo(mensaje):
    while True:
        ...
        try:
            ...
            print("Error: Debe ingresar un número válido sin puntos ni comas.")
...
if __name__ == '__main__':
    print("¡Bienvenido a Calculadora Pensional!")
    while True:
        opcion = mostrar_menu()
        if opcion == "1":
